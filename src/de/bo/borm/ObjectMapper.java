...
public class ObjectMapper {
    ...
    class SelectIterator implements Iterator {
        ...
        SelectIterator(PreparedStatement stmt) throws SQLException {
        	this.stmt = stmt;
        ...
        public boolean hasNext() throws RuntimeSQLException {
            if (alreadyAsked == null) {
                try {
		            ...
		            if (! alreadyAsked.booleanValue()) {
		            	// We have iterated through the whole result set. We can close it now.
		            	rs.close();
		            	rs = null;
		            	stmt.close();
		            	stmt = null;	
